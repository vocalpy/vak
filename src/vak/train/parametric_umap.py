...
from ..datasets.dimensionality_reduction import ParametricUMAPDataset
...
def train_parametric_umap_model(
    ...
    metadata = datasets.dimensionality_reduction.Metadata.from_dataset_path(dataset_path)
    ...
    if val_step:
        transform = transforms.get_defaults(
            "eval",
        )
