...
def from_df(dataset_df: pd.DataFrame,
            dataset_path: str | pathlib.Path) -> list[crowsetta.Annotation] | None:
    ...
    if len(dataset_df["annot_path"].unique()) == 1:
        ...
        annots = scribe.from_file(dataset_path / annot_path).to_annot()
        ...
        annots = [
            scribe.from_file(dataset_path / annot_path).to_annot() for annot_path in dataset_df["annot_path"].values
        ]
