...
def expected_spect_files_returned(spect_files_returned,
    ...
    assert all([expected_spect_file in spect_files_returned
    ...
    if source_audio_files_not_expected is not None:
        ...
        assert all([not_expected_spect_file not in spect_files_returned
                    for not_expected_spect_file in not_expected_spect_files])

    return True  # if all asserts were True


def test_to_spect_audio_dir_annot_cbin_with_labelset(default_spect_params,
                                                     tmp_path,
                                                     audio_dir_cbin,
                                                     annot_list_notmat,
                                                     labelset_notmat,
    ...
    assert expected_spect_files_returned(spect_files,
                                         audio_list_cbin_all_labels_in_labelset,
                                         audio_list_cbin_labels_not_in_labelset)


def test_audio_dir_annot_cbin_no_labelset(default_spect_params,
                                          tmp_path,
                                          audio_dir_cbin,
                                          audio_list_cbin,
                                          annot_list_notmat,
...
def test_audio_dir_without_annot(default_spect_params,
                                 tmp_path,
                                 audio_dir_cbin,
                                 audio_list_cbin,
                                 ):
...
def test_audio_files_cbin_annot_notmat(default_spect_params,
                                       tmp_path,
                                       audio_list_cbin,
                                       annot_list_notmat,
                                       labelset_notmat,
...
def test_audio_files_annot_cbin_no_labelset(default_spect_params,
                                            tmp_path,
                                            audio_list_cbin,
                                            annot_list_notmat,
                                            ):
...
def test_audio_annot_map_cbin(default_spect_params,
                              tmp_path,
                              audio_list_cbin,
                              annot_list_notmat,
                              labelset_notmat,
...
def test_audio_annot_map_cbin_no_labelset(default_spect_params,
                                          tmp_path,
                                          audio_list_cbin,
                                          annot_list_notmat,
                                          labelset_notmat,
...
def test_missing_inputs_raise(default_spect_params,
                              tmp_path,
                              audio_dir_cbin,
                              audio_list_cbin,
                              annot_list_notmat,
...
def test_invalid_audio_format_raises(default_spect_params,
                                     tmp_path,
                                     audio_dir_cbin,
                                     audio_list_cbin,
                                     annot_list_notmat,
...
def test_both_audio_dir_and_audio_files_raises(default_spect_params,
                                               tmp_path,
                                               audio_dir_cbin,
                                               audio_list_cbin,
                                               annot_list_notmat,
...
def test_both_audio_dir_and_audio_annot_map_raises(default_spect_params,
                                                   tmp_path,
                                                   audio_dir_cbin,
                                                   audio_list_cbin,
                                                   annot_list_notmat,
...
def test_both_audio_list_and_audio_annot_map_raises(default_spect_params,
                                                    tmp_path,
                                                    audio_dir_cbin,
                                                    audio_list_cbin,
                                                    annot_list_notmat,
...
def test_both_annot_list_and_audio_annot_map_raises(default_spect_params,
                                                    tmp_path,
                                                    audio_dir_cbin,
                                                    audio_list_cbin,
                                                    annot_list_notmat,
