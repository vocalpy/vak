...
class TestSplit(unittest.TestCase):
    ...
    def test_train_test_dur_split_inds_mock_easy(self):
        ...
        for _ in range(NUM_SAMPLES):
            train_inds, val_inds, test_inds = vak.utils.split.train_test_dur_split_inds(durs,
                                                                                        labels,
                                                                                        labelset,
                                                                                        train_dur,
                                                                                        test_dur)
    ...
    def test_train_test_dur_split_inds_mock_impossible(self):
        ...
        with self.assertRaises(ValueError):
            vak.utils.split.train_test_dur_split_inds(durs,
                                                      labels,
                                                      labelset,
                                                      train_dur,
                                                      test_dur,
    ...
    def test_train_test_dur_split_inds_cbin_train_test_val(self):
        ...
        for _ in range(NUM_SAMPLES):
            train_inds, val_inds, test_inds = vak.utils.split.train_test_dur_split_inds(self.durs_cbin,
                                                                                        self.labels_cbin,
                                                                                        self.labelset_cbin,
                                                                                        train_dur,
                                                                                        test_dur,
    ...
    def test_train_test_dur_split_inds_mat_train_test_val(self):
        ...
        for _ in range(NUM_SAMPLES):
            train_inds, val_inds, test_inds = vak.utils.split.train_test_dur_split_inds(self.durs_mat,
                                                                                        self.labels_mat,
                                                                                        self.labelset_mat,
                                                                                        train_dur,
                                                                                        test_dur,
    ...
    def test_train_test_dur_split_mat_train_test(self):
        ...
        train_vds, test_vds = vak.utils.split.train_test_dur_split(vds,
