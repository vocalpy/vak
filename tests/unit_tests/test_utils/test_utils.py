...
class TestUtils(unittest.TestCase):
    def test_validate_durs(self):
        ...
        test_dur_in = 75
        vds_dur = 200
        train_dur_out, val_dur_out, test_dur_out = vak.util.split._validate_durs(train_dur_in,
                                                                                 val_dur_in,
                                                                                 test_dur_in,
                                                                                 vds_dur)
        self.assertTrue(
        ...
        with self.assertRaises(ValueError):
            ...
            vak.util.split._validate_durs(train_dur_in,
                                          val_dur_in,
                                          test_dur_in,
                                          vds_dur)
        ...
        with self.assertRaises(OnlyValDurError):
            vak.util.split._validate_durs(train_dur_in, val_dur_in, test_dur_in, vds_dur)
