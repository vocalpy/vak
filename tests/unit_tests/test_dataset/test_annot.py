...
class TestAnnot(unittest.TestCase):
    ...
    def test_source_annot_map_wav_koumura(self):
        ...
        source_annot_map = vak.dataset.annot.source_annot_map(source_files=audio_files,
    ...
    def test_source_annot_map_cbin_yarden(self):
        ...
        source_annot_map = vak.dataset.annot.source_annot_map(source_files=spect_files,
                                                              annot_list=annot_list)
