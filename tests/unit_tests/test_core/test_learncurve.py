...
class TestLearncurve(unittest.TestCase):
    ...
    def _check_learncurve_output(self, train_config, nets_config, prep_config,
    ...
    def test_learncurve_func(self):
        ...
        vak.core.learning_curve(train_vds_path=train_config.train_vds_path,
                                ...
                                output_dir=train_config.root_results_dir,
        ...
        self.assertTrue(self._check_learncurve_output(
            train_config, nets_config, prep_config, time_before, time_after
        ))
